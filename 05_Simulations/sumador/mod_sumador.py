...
from LZA import LZA
from pp_functions import pp_bits, pp_bits_spaced, pp_hex, float_to_bits
...
def main(num1, num2, num3, num4):
    ...
    lzcounter, sum_ovf, one_bit_less_error = LZA(carry, save, signos, (3 * PRECISION_BITS) + 2)
    ...
    exp_final = exponentes[shifteos.index(0)] + 2 - actual_lzcounter 

    print(f"Normalizacion exponente:")
    print(f"    Exponente maximo: {exponentes[shifteos.index(0)]}")
    ...
    # devolver listas de señales de assert y resultado.
    # return
