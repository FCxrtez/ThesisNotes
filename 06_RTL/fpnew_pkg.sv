...
package fpnew_pkg;
  ...
  // | FP16       | IEEE binary16    | 16 bit | 5        | 10 111_1111_1110
  ...
  typedef enum logic [2:0] {
    ADDMUL, DIVSQRT, NONCOMP, CONV, REDUCTION
  } opgroup_e;
  ...
  typedef enum logic [OP_BITS-1:0] {
    ...
    ADDS, FREDSUM                // ADDMUL operation group (ADDS is added here to preserve bit encoding of operations)
  } operation_e;
  ...
  function automatic int unsigned max_exp_dif(fp_format_e fmt);
    unique case (fmt)
      FP32: return 254;
      FP64: return 2046;
      FP16: return 30;
